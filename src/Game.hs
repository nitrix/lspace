...
gameReadLink :: (J.FromJSON a, J.ToJSON a) => Link a -> Game a
gameReadLink = Game . MaybeT . lift . readLink

gameModifyLink :: (J.FromJSON a, J.ToJSON a) => Link a -> (a -> a) -> Game ()
gameModifyLink link f = Game . MaybeT . lift $ Just <$> modifyLink link f

gameWriteLink :: (J.FromJSON a, J.ToJSON a) => Link a -> a -> Game ()
